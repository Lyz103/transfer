...
class ChatMemory(ExplicitMemory):
    ...
    def __init__(self, config) -> None:
        ...
        self.store_op = ChatMemoryStore(self.config.args.store, storage = self.storage)
        self.recall_op = ChatMemoryRecall(self.config.args.recall, storage = self.storage)
