...
class iEvaLM_User_Beauty(Agent):
    def __init__(self, target_item: str, item_info: str, model_name="gpt-3.5-turbo", name="iEvaLMUserBeauty",
    ...
    def _get_random_item(self):
        ...
        Possible target items can be "洁面乳", "爽肤水", "化妆水", "精华", "乳液", "面霜", "眼霜", "防晒霜"
        ...
        try:
            ...
            target_item = random.choice(["洁面乳", "爽肤水", "化妆水", "精华", "乳液", "面霜", "眼霜", "防晒霜"])
        try:
